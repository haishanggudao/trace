...
$.barcode = {
	...
	digitToBmp: function($container, settings, digit, hri){
        ...
        object.setAttribute('width',barWidth * width);
        if (settings.showHRI){
            // add HRI centered
        	 var code = document.createElement('div');
        	 code.setAttribute('style',"clear:both; width: 100%; background-color: " + settings.bgColor + "; color: " + settings.color + "; text-align: center; font-size: " + settings.fontSize + ";");
        	 code.innerHTML=hri;
        	$container.html("").append(object).append(code);
		}else{
