...
<div id="itemBtns" style="padding: 5px 0;">
	...
	<shiro:hasPermission name="system:company:import">
		<a href="#" class="easyui-linkbutton"
			data-options="iconCls:'icon-excel'" onclick="importCompany();">企业信息导入</a>
	</shiro:hasPermission>
	&nbsp;搜索关键词:&nbsp;<input data-options="prompt:'关键词可以输入任意字段'"
		class="easyui-textbox" id="name_CompanySearch" name="name"
		style="width: 200px; height: 26px"> &nbsp;<a href="#"
		class="easyui-linkbutton" iconcls="icon-search"
		onclick="reloadCompany()">搜索</a> &nbsp;<a href="#"
		class="easyui-linkbutton" iconcls="icon-search"
		onclick="$('#dlg_companySearch').dialog('open')">高级搜索</a>
</div>
<table id="itemsgrid" title="公司列表" style="width: 100%;"></table>
			...
			<div title="可选" style="padding: 5px;">
				...
				<div class="fitem">
					<label class="fitemlabel width_100">有效日期:</label> <input
						...
						id='company_ceffectivedate1' style="width: 180px;"
						data-options="prompt:'起始日期'">&nbsp;--&nbsp;<input
						class="easyui-datebox" name="ceffectivedate2"
						id='company_ceffectivedate2' style="width: 180px;"
...
function ajaxLoading(){
 ...
 function ajaxLoadEnd(){
	...
	function reloadCompany() {
		$('#itemsgrid').datagrid({  
		    url:'company/findAllList?findType=1',  
		    queryParams:{
	...
	function searchform() {
		$('#itemsgrid').datagrid({  
		    url:'company/findAllList?findType=2',  
		    queryParams:{
