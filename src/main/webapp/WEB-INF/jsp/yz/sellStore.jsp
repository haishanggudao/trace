...
<table id="Customersgrid" title="羽众酒业-零售门店列表" style="width: 100%;"></table>
...
style="width: 780px; padding: 10px;"  buttons="#dlg_Customers-buttons" >	 
	...
	<form id="CustomerForm" method="post">
		...
		<div class="fitem">
			...
			<label class="fitemlabel width_100">法人姓名:</label> 
			<input
	...
	<form id="queryCustomerForm" method="post">
		...
		<div class="fitem">
			<label class="fitemlabel width_100">工商注册号:</label> <input
				...
				data-options="prompt:'工商注册号'">&nbsp;
			<label class="fitemlabel width_100">客户类别:</label> 
			<input
