...
<div class="easyui-layout" style="width:100%; " data-options="fit:true">
	<div id="p_productMaterial" data-options="region:'west',split:true" title="类别" style="width:20%; ">
		<table class="easyui-treegrid" 
            data-options="
				...
				onClickRow : function(row) {
					// console.info(row);
					loadProductMaterialByCategory(row.productCategoryId);
				}
            ">
	        <thead>
	            <tr>
	...
	<div data-options="region:'center'" title="原料列表">
		<div id="materialbar" style="padding: 5px 0;">
		<shiro:hasPermission name="base:material:add">
			<a href="#" class="easyui-linkbutton" iconCls="icon-add-s1" onclick="materialAdd()">新增原料</a>
		</shiro:hasPermission>
		<shiro:hasPermission name="base:material:edit">
			<a href="#" class="easyui-linkbutton" iconCls="icon-edit-s1" onclick="materialEdit()">修改原料</a>
		</shiro:hasPermission>
		<shiro:hasPermission name="base:material:delete">
			<a href="#" class="easyui-linkbutton" iconCls="icon-delete-s1" onclick="materialRemove()">删除原料</a>
		</shiro:hasPermission>
		...
		<shiro:hasPermission name="base:material:list">
				&nbsp;分类：&nbsp;
				<select id="searchMaterialCategoryId_material" name="productCategoryId" style="width: 160px;" />
				<a href="#" class="easyui-linkbutton" iconcls="icon-search" onclick="loadMaterial()">搜索</a>
		</shiro:hasPermission>
		</div>
...
<script type="text/javascript">
	...
	$(function() {
		$("#searchMaterialCategoryId_material").combobox(
				{
					url : 'product_category/list',
					method : 'post',
		...
		$('#materialForm').form(
				'submit',
				{
					...
					onSubmit : function(param) {
						...
						param.companyId = $("#index_user_companys").combobox("getValue");
// 						if(!$("#materialImgFilebox").filebox('imgVerify',{})){
// 							return false;
// 						}
	...
	function loadProductMaterialByCategory(productCategoryId) {
