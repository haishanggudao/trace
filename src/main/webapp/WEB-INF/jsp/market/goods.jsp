...
<div class="easyui-layout" style="width:100%; " data-options="fit:true">
	<div id="p_goods" data-options="region:'west',split:true" title="类别" style="width:20%; ">
		<table class="easyui-treegrid" 
            data-options="
                url: 'product_category/listGoods',
                method: 'get',
                rownumbers: true,
		...
		$('#goodsList').datagrid(
				{
					...
					var prValue = $("#searchProductCategoryId_productGoods").combobox('getValue');
					param.productCategoryId = prValue;
					param.createTimeOne = $('#createTimeOne').datebox('getValue');
					param.createTimeTwo = $('#createTimeTwo').datebox('getValue');
					},
					columns : [ [ {
						field : 'goodsck',
						checkbox : true
