	...
	<form id="SupplierForm" method="post">
		...
		<div class="fitem">
			...
			<!-- <label class="fitemlabel width_100">联系人别名:</label> <input
				...
				data-options="prompt:'联系方式',required:true,validType:[length[1,60]]">&nbsp;
		</div>
		<div class="fitem">
				...
				$('#Suppliersgrid').datagrid(
						{
							...
							{ field : 'companyCregistrationnumber', title : '经营地址', width : '26%',
...
// 					hasDownArrow : false,
					...
					onSelect:function(data){
						$('#SupplierForm').form('load', {
							...
							cname : data.company.cname,
							cidnumb : data.company.cidnumb,
							clegalpersonaddress : data.company.clegalpersonaddress,
							cbusinesslicense : data.company.cbusinesslicense,
							cbusinessscope : data.company.cbusinessscope,
							cbusinessaddress : data.company.cbusinessaddress,
							chygienelicense : data.company.chygienelicense
						});
						if(data.company != undefined && data.company != null && data.company.ceffectivedate1 != undefined && data.company.ceffectivedate1 != '') {
							var date = new Date(data.company.ceffectivedate1);
							$('#supplier_ceffectivedate1').datebox('setValue',date.format("yyyy-MM-dd"));
						}
						if(data.company != undefined && data.company != null && data.company.ceffectivedate2 != undefined && data.company.ceffectivedate2 != '') {
							var date = new Date(data.company.ceffectivedate2);
							$('#supplier_ceffectivedate2').datebox('setValue',date.format("yyyy-MM-dd"));
						}
					}
				});
