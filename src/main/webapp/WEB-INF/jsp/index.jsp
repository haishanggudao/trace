...
<body class="easyui-layout" >
	...
	<div class="wu-header" data-options="region:'north',border:false,split:true">
    	<div class="wu-header-left">
        	<h1 style="font-family:微软雅黑" id="head_title">上海市食品安全信息追溯公共服务平台</h1>
        </div>
        <div class="wu-header-right">
        	<input type="hidden" id="index_token" name="token" value="${token }">
        	
     	   	<input id="index_userName" type="hidden" value="${userInfo.nickName }">
        	<p style="float: left"><strong class="" style="margin-right: 10px;">${userInfo.nickName }</strong><input id="index_user_companys">，欢迎您！</p>
    ...
    <div class="wu-main" data-options="region:'center'">
        ...
        <!-- data-options="href:'temp/layout-1  .html',closable:false,iconCls:'icon-tip',cls:'pd3'" -->
            <div title="欢迎进入"> 
                <img id="bg_cont" width="100%" height="100%" alt="" src="static/images/bg_cont.jpg">                          
            </div>
