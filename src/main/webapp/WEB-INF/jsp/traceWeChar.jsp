					...
					<div class="cd-timeline-content">
						<ul>
							<c:if test="${not empty  traceInfo.instockInfo.supplier.supplierAlias}">
								<li style='color:#222'>源头企业名称:<span style='color:#666;word-break: break-all'>${traceInfo.instockInfo.supplier.supplierAlias}</span></li>
							</c:if>
							...
							<c:if test="${not empty  traceInfo.instockInfo.supplier.supplierAddress}">
								<li style='color:#222'>地址:<span style='color:#666;word-break: break-all'>${traceInfo.instockInfo.supplier.supplierAddress}</span></li>
							</c:if>
						</ul>
					</div>
				</div>
			...
			<div class="main-model">
				...
				<div class="cd-timeline-content">
					<ul>
						...
						<c:if test="${not empty  traceInfo.outstockInfo.outstockNum}">
						<li style='color:#222'>出库批次号:<span style='color:#666;word-break: break-all'>${traceInfo.outstockInfo.outstockNum}</span></li>
						</c:if>
						<c:if test="${not empty  traceInfo.outstockInfo.consignor}">
						<li style='color:#222'>签收人:<span style='color:#666;word-break: break-all'>${traceInfo.outstockInfo.consignor}</span></li>
						</c:if>
					</ul>
				</div>
			</div>
				...
				<div class="cd-timeline-content">
					<ul>
						<c:if test="${not empty  traceInfo.company.name}">
							<li style='color:#222'>供应商名称:<span style='color:#666;word-break: break-all'>${traceInfo.company.name }</span></li>
						</c:if>
					...
					<div class="main-model">
						<div class="gloab-title clearfix">
								<div class="cd-timeline-img cd-movie">
									...
									<span class="gont">门店信息</span>
						</div>
						<div class="cd-timeline-content">
								<ul>
									<c:if test="${not empty  traceInfo.customers.customerAlias}">
											<li style='color:#222'>门店名称:<span style='color:#666;word-break: break-all'>${traceInfo.customers.customerAlias}</span></li>
									</c:if>
									<c:if test="${not empty  traceInfo.customers.contact}">
											<li style='color:#222'>联系人:<span style='color:#666;word-break: break-all'>${traceInfo.customers.contact}</span></li>
									</c:if>
									<c:if test="${not empty  traceInfo.customers.tel}">
											<li style='color:#222'>电话:<span style='color:#666;word-break: break-all'>${traceInfo.customers.tel}</span></li>
									</c:if>
									<c:if test="${not empty  traceInfo.customers.company.cbusinessaddress}">
											<li style='color:#222'>门店地址:<span style='color:#666;word-break: break-all'>${traceInfo.customers.company.cbusinessaddress}</span></li>
									</c:if>
								</ul>
							</div>
						</div>
