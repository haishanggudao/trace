 ...
 * @author 黄苇
 * 
 * @date 2016年10月26日 下午5:42:07
 *
 */
/**
 * @author 黎学扬
 * 
 * @date 2016年10月27日 下午4:07:46
 *
 */
@NameStyle(Style.normal)
@Table(name="t_company")
public class JinJiCompany extends BaseEntity {
	/**企业ID*/
	@Id
    ...
    /**#产品图片文件 可能无用*/
    @Transient
	private MultipartFile companyImgchyienelicensefile;
	 ...
	 * @return the companyImgfile
	 */
	public MultipartFile getCompanyImgchyienelicensefile() {
		return companyImgchyienelicensefile;
	}
	/**
	 * 设置 #其他证件片文件 可能无用
	 * @param companyImgfile the companyImgfile to set
	 */
	public void setCompanyImgchyienelicensefile(MultipartFile companyImgchyienelicensefile) {
		this.companyImgchyienelicensefile = companyImgchyienelicensefile;
	}
	/* (non-Javadoc)
	...
	public String toString() {
		return "JinJiCompany [companyid=" + companyid + ", name=" + name + ", shortname=" + shortname + ", code=" + code
				...
				+ ", ceffectivedate1=" + ceffectivedate1 + ", ceffectivedate2=" + ceffectivedate2 + ", licenseUrl="
				+ licenseUrl + ", chygienelicenseUrl=" + chygienelicenseUrl + ", companyImgfile=" + companyImgfile +",companyImgchyienelicensefile="+companyImgchyienelicensefile+"]";
	}
